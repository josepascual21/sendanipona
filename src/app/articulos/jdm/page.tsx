...
export default function JdmPage() {
    return (
        <div className="bg-slate-900 text-slate-200 font-sans selection:bg-red-800 selection:text-white overflow-x-hidden">
            ...
            <div className="relative z-10">
                ...
                {/* ========== DRIFT (OSCURO TONO A) ========== */}
                <section id="drift" className="py-24 md:py-32 bg-slate-950 relative">
                ...
                <section id="quedadas" className="py-24 md:py-32 bg-slate-900 px-6">
                ...
                <section id="modelos" className="py-24 md:py-32 bg-slate-950 text-white">
                    <div className="max-w-7xl mx-auto px-6">
                        <motion.div
                            initial={{ opacity: 0, y: 30 }}
                            whileInView={{ opacity: 1, y: 0 }}
