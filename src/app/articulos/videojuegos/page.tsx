...
export default function VideojuegosPage() {
    return (
        <div className="bg-slate-900 text-slate-200 font-sans selection:bg-emerald-500/30 selection:text-white overflow-x-hidden">
            ...
            <div className="relative z-10">
                ...
                {/* ========== INTRO (OSCURO TONO B) ========== */}
                <section id="intro" className="py-24 md:py-32 px-6 min-h-[80vh] flex items-center bg-slate-900">
                ...
                <section id="8-16bit" className="py-24 md:py-32 bg-slate-950 relative">
                ...
                <section id="arcades" className="py-24 md:py-32 bg-slate-900 px-6 overflow-hidden">
                ...
                <section id="franquicias" className="py-24 md:py-32 bg-slate-950">
                    <div className="max-w-7xl mx-auto px-6">
                        <motion.div
                            initial={{ opacity: 0, y: 30 }}
                            whileInView={{ opacity: 1, y: 0 }}
                ...
                <section id="tecnologia" className="py-24 md:py-32 bg-slate-900 relative overflow-hidden">
